...
?>
<section class="carousel" aria-label="Gallery" data-flickity='{ "autoPlay" : true }'>
    <li id="carousel__slide1" tabindex="0" class="carousel-cell">
    ...
    <li id="carousel__slide2" tabindex="0" class="carousel-cell">
        <div class="container homepage-banner">
            <div class="column is-5-desktop is-offset-7-desktop has-text-centered has-text-right-desktop py-6">
                <h1 class="title has-text-white">Air Head komposteringstoalett</h1>
                <h2 class="subtitle has-text-white">
    ...
    <li id="carousel__slide3" tabindex="0" class="carousel-cell">
        <div class="container homepage-banner">
            <div class="column is-5-desktop is-offset-7-desktop has-text-centered has-text-right-desktop py-6">
                <h1 class="title has-text-white">Air Head komposteringstoalett</h1>
                <h2 class="subtitle has-text-white">
